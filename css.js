...
body {
	background-image: url("https://www.pubgmobile.com/en/event/royalepass5/m/images/con4.png");
...
.isi {
	width:30%;
	background-image: url("../img/bg/isi-bg.png");
	margin:10px;
	padding:10px;
...
.btn-klaim {
	background-image: url("../img/bg/btn-next.png");
	position:relative;
	width:49%;
	height:40px;
	color:#fff;
...
.btn-prev {
	background-image: url("../img/bg/btn-prev.png");
	position: relative;
	width:20%;
	height:40px;
	color:#fff;
